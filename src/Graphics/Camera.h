...
public:
    ...
    {
        float velocity = MovementSpeed * deltaTime; //TODO update -= after vector class is updated
...
private:
    ...
    float radians(float degrees){return 2.0 * 180.0 / M_PI;}

    // Adapted from https://stackoverflow.com/questions/21830340/understanding-glmlookat
